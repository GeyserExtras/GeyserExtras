...
public class VRInventoryMenu extends BedrockMenu {
    ...
    public SimpleForm create(ExtrasPlayer player) {
        ...
        add(new Button(Action.OPEN_INVENTORY.translate(player), FormImage.Type.PATH, "textures/ui/inventory_icon.png", () -> {
        ...
        add(new Button(Action.OPEN_GE_MENU.translate(player), FormImage.Type.URL, "https://cdn.modrinth.com/data/kOfJBurB/2592d098bd31c083365e1c8d831446220995f1d7.png", () -> {
